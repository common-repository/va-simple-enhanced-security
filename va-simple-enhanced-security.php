...
class VA_SIMPLE_ENHANCED_SECURITY {
	...
	function __construct() {
		VASES_MODUL_SETTINGS_API::init();
		VASES_MODUL_SEND_MAIL::init();
		VASES_MODUL_BASIC_AUTH::init();
		VASES_MODUL_DIGEST_AUTH::init();
		VASES_MODUL_IP_LIMITATION::init();
		VASES_MODUL_EMAIL_LOGIN::init();
		VASES_MODUL_AUTHOR_BASE::init();
		VASES_MODUL_ETC::init();
	...
	public static function activation() {
		...
		$wp_roles->remove_cap( 'editor', 'edit_plugins' );
	...
	public static function uninstall() {
		...
		$wp_roles->add_cap( 'editor', 'edit_plugins' );
